namespace HubPortal.QueryGenerator.ContextFreeGrammar {
    ...
    /// <summary>
    /// CConstants to represent the string values for all symbols in the Context Free Grammar.
    /// </summary>
    public class Symbols {
        ...
        public const string PROCESS_LIST = "processList";
        ...
        public const string TRANSACTION_DETAIL = "transactionDetail";

        public const string TRANSACTION_ID = "transactionid";

        public const string TRANSACTION_TYPE = "transactionType";

        public const string TRANSACTION_TYPE_LIST = "transactionTypeList";
        ...
        public const string XREF_DATA = "xRefData";
